...
class GestionUsuarios:
    ...
    y `actualizarUsuario` son la traducción literal de ese diagrama y
    son usados directamente (sin alias) por el resto de los casos de
    uso del sistema.
    """
    ...
    def obtenerUsuarioPorId(self, usuario_id: int) -> Usuario:
    ...
    def guardarUsuario(self, usuario: Usuario) -> Usuario:
        try:
            ...
            self._db.commit()
            return self.obtenerUsuarioPorId(cursor.lastrowid)
